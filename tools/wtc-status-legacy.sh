...
#
# Superseded as the wtc-status.sh / wtc-status-tui.sh pane by the shared
# wtc-status-common.sh implementation. Kept under this name, unwired from
# wtc-open.sh / retire.sh, for comparison while the new stack settles.
